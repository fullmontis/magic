...
Group.prototype.update = function( arg1, arg2, arg3, arg4, arg5 ) { // fix: accept all arguments
    for( var spriteName in this.group ) {
	this.group[spriteName].update( arg1, arg2, arg3, arg4, arg5 );
    }
};

Group.prototype.render = function( context, arg1, arg2, arg3 ) {
    for( var spriteName in this.group ) {
	this.group[spriteName].render( context, arg1, arg2, arg3 );
    }
};

Group.prototype.getSpriteFromName = function ( name ) {
...
Group.prototype.getNumber = function() {
